...
I dina GraphQL-frågor måste du ange flera HTTP-huvuden, inklusive den offentliga API-nyckeln som du lade till i konfigurationen för Adobe Commerce Services Connector i Admin. Mer information finns i dokumentationen för [Storefront Services GraphQL](https://developer.adobe.com/commerce/webapi/graphql/schema/).
...
Mer information om [!DNL Catalog Service]-datasynkronisering finns i [Kontrollpanelen för datahantering](https://experienceleague.adobe.com/sv/docs/commerce-admin/systems/data-transfer/data-dashboard).
