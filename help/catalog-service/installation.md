...
Installera katalogtjänsten om du vill begära och ta emot produktdata från en Commerce-instans med [katalogtjänstens GraphQL API](https://developer.adobe.com/commerce/webapi/graphql/schema/catalog-service/). Katalogtjänsten levereras som ett PHP-metapaket för en disposition från repo.magento.com.
...
>
>Om du använder Adobe Commerce as a Cloud Service är den senaste versionen av metapaketet tillgänglig i din miljö. Information om hur du börjar använda tjänsterna finns i [Komma igång med katalogtjänsten](get-started.md).
>
>Information om implementeringar av Commerce storefront med Adobe Commerce Optimizer finns i [Utvecklarhandbok för marknadsföringstjänster](https://developer-stage.adobe.com/commerce/services/optimizer/).
...
1. Utför en inledande datasynkronisering från [Dashboard för datahantering](https://experienceleague.adobe.com/sv/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard).
...
Från Commerce Admin kan du övervaka synkroniseringsprocessen med [Dashboard för datahantering](https://experienceleague.adobe.com/sv/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard). Använd [Commerce CLI](../data-export/data-export-cli-commands.md#troubleshooting) och loggar för att hantera och felsöka processen.
