...
![Nytt](../assets/new.svg) Frågan `categoryTree` i GraphQL API returnerar nu kategoribeskrivningar, bilder och SEO-metataggar. Den här uppdateringen innehåller de data som utvecklare av butiker behöver för att visa kategoribilder och förbättra sökmotoroptimeringen med korrekta metatitlar, beskrivningar och nyckelord. Stöds endast för Commerce-implementeringar som använder datamodellen [för sammansatta kataloger](https://developer.adobe.com/commerce/services/optimizer/) för headless-butiker&lt;<!--DATA-6933-->
