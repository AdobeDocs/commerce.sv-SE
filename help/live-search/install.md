...
- **Skiktad sökning** – Sök i en annan sökkontext – Med den här funktionen kan du utföra upp till två lager av sökning efter dina sökfrågor. Exempel:

   - **Lager 1-sökning** - Sök efter &quot;motor&quot; på &quot;product_attribute_1&quot;.
   - **Lager 2-sökning** - Sök efter &quot;artikelnummer 123&quot; på &quot;product_attribute_2&quot;. I det här exemplet söker du efter &quot;artikelnummer 123&quot; i resultatet för &quot;motor&quot;.
...
Att få din produktdata korrekt konfigurerad säkerställer bra sökresultat för dina kunder. I det här avsnittet aktiverar du widgetar för produktlistor och tilldelar kategorier.
...
Du kan formatera popover- och PLP-widgetarna genom att definiera anpassade CSS-regler efter behov. Se [Styling av flytande fönsterelement](storefront-popover.md#styling-popover-example) och [widget](plp-styling.md#styling-example) för produktlistningssida.

Om du vill utöka funktionerna i widgetarna är källkoden för var och en tillgänglig på en offentlig lagringsplats.
I det här scenariot kan du anpassa JavaScript efter dina egna behov och sedan vara värd för din anpassade kod på ditt CDN. Det här anpassade skriptet [!DNL Live Search] kommunicerar med tjänsten och returnerar resultatet som vanligt, så att du kan styra widgetens funktioner.

- [Lagringsplats för PLP-widget](https://github.com/adobe/storefront-product-listing-page)
...
Om du har en anpassad headless-implementering kan du ta en titt på [!DNL Live Search] referensimplementeringarna:
