...
1. Gå till _>_ på sidofältet **[!UICONTROL Sales]** Admin **[!UICONTROL Payment Services]**. Vyn för visualisering av utbetalningsdata visas i avsnittet Utbetalningar.
...
1. Gå till _>_ > **[!UICONTROL Sales]** > **[!UICONTROL Payment Services]** på sidofältet _[!UICONTROL Payouts]_&#x200B;Admin **[!UICONTROL View Report]**.
...
1. Gå till _>_ > **[!UICONTROL Sales]** > **[!UICONTROL [!DNL Payment Services]]** på sidofältet _[!UICONTROL Payouts]_&#x200B;Admin **[!UICONTROL View Report]**.
...
1. Klicka på ikonen _Hämta_ ( ![Ikonen Hämta](assets/icon-download.png){width="20" zoomable="yes"} ).
