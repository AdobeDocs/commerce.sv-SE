...
1. Om du vill aktivera [!DNL Payment Services] som betalningsmetod för din butik växlar du _[!UICONTROL General]_till **[!UICONTROL Enable Payment Services as payment method]**i avsnittet `Yes`.
