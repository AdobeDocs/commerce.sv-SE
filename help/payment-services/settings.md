...
1. Om du vill aktivera [!DNL Payment Services] som betalningsmetod för din butik växlar du _[!UICONTROL General]_&#x200B;till **[!UICONTROL Enable Payment Services as payment method]**&#x200B;i avsnittet `Yes`.
...
Du kan bara använda Apple Pay om du slutför [Apple Pay self-registrering via Paypal](https://developer.paypal.com/docs/checkout/apm/apple-pay/#register-your-live-domain) och sedan [konfigurerar Apple Pay](configure-admin.md/#payment-buttons) för dina butiker.
