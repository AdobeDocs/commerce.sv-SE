---
title: '[!DNL Merchandising Services] - översikt'
description: Lär dig hur du med  [!DNL Merchandising Services] for Adobe Commerce kan konfigurera din katalog så att den matchar din affärsmodell och din marknadsstrategi
...
# [!DNL Merchandising Services] - översikt
...
- Infoga data i Merchandising Services med [API:t för datainhämtning](https://developer-stage.adobe.com/commerce/services/composable-catalog/data-ingestion/using-the-api/).
...
- [Slutför en självstudiekurs](https://developer-stage.adobe.com/commerce/services/composable-catalog/merchandising-services-use-case/) som visar hur ett företag med en enda baskatalog kan använda Merchandising Services API:er för att lägga till produktdata, definiera kataloger med projektioner och hämta katalogdata för visning i en headless Store.
