...
>[!NOTE]
>
>Endast produktadministratörer och systemadministratörer kan lägga till användare och utvecklare i produkten [!DNL Adobe Commerce Optimizer].
...
- Lägg till flera användare i en roll genom att skapa en [användargrupp](https://helpx.adobe.com/se/enterprise/using/user-groups.html){target="_blank"}. Sedan kan du lägga till lämpliga produkter i användargruppen.
