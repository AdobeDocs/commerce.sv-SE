...
**jacka** ![Tvåvägsväljare](../../assets/two-way.png) jacka
**byxor** ![Tvåvägsväljare](../../assets/two-way.png) slackar ![Tvåvägsväljare](../../assets/two-way.png) byxor
...
**tröja** ![Envägsväljare](../../assets/one-way.png) hoodie
**byxor** ![Envägsväljare](../../assets/one-way.png) kapris ![Envägsväljare](../../assets/one-way.png) kalvbyxor ![Envägsväljare](../../assets/one-way.png) pedagogik

## Beteende för synonym med flera ord

För synonymer med flera ord betraktas synonymen som en fras av [!DNL Adobe Commerce Optimizer]. Om du till exempel skapar en tvåvägssynonym **matrumstabell** ![Tvåvägsväljare](../../assets/two-way.png) **kökstabell** ![Tvåvägsväljare](../../assets/two-way.png) **matningstabell** söker [!DNL Adobe Commerce Optimizer] igenom alla fält som är inställda på sökbara för förekomsten av **matrumstabell** eller **3&rbrace;kökstabell** eller **matbord**.
