...
>[!TIP]
>
> Använd de [Commerce-resursroller](https://experienceleague.adobe.com/sv/docs/commerce-admin/catalog/products/digital-assets/product-image#image-roles) som stöds, som `thumbnail`, `image`, `small_image` och `swatch_image`, i nyckeln `asset_roles`.
