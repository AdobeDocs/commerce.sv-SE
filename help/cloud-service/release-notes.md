...
### Intern (SOM SKA TAS BORT)

Följande förbättringar av infrastrukturen ingår:

* Uppgraderade [!DNL Adobe Commerce]-kärna från 2.4.8-p3 till 2.4.8-p4. <!-- CCSAAS-4588 -->

* Sessionshantering för gästutcheckning har korrigerats så att kundvagnsofferten är korrekt associerad och underhållen under gästens utcheckningsflöde. <!-- ACCS-261 -->

* Utökad felloggning från GraphQL för att hämta fullständiga stackspårningar för undantag, vilket förbättrar felsökningsmöjligheterna. <!-- ACCS-305 -->

* Ported Company Resolver GraphQL test suite to the CCSaS test environment. <!-- CCSAAS-2122 -->

* Korrigerade administratörsscenariofel i PAT-devbox CI-byggen. <!-- ACCS-351 -->

* Ett produktgenereringsscenario har lagts till i PAT-trendbyggen. <!-- CCSAAS-4498 -->

* Ported BundleRequisitionList GraphQL test suite to the CCSaS test environment. <!-- CCSAAS-2113 -->

* Parallelliserad testkörning av GraphQL API-funktionalitet i CI för att minska feedbacktiden. <!-- CCSAAS-4607 -->

* Uppdaterad README-dokumentation. <!-- ACCS-404 -->

* Utökade AI-regler för pekaren för CCSaS-repokontext. <!-- PR #1295 -->

* Inaktuella migreringsfiler har tagits bort. <!-- PR #1296 -->

* Inaktiverad mallbearbetning vid generering av prestandadata. <!-- PR #1297 -->

* Lagt till markörregler och Magento CLI-dokumentation. <!-- PR #1300 -->

* Ett hjälpskript för lokal databas har lagts till för utveckling. <!-- PR #1305 -->

* Introducerade regler för markörsäkerhetskodning. <!-- PR #1306 -->

* Optimerad statisk CI-analys som endast körs på ändrade filer. <!-- PR #1309 -->
