...
Följande objekt är för närvarande bara tillgängliga i sandlådemiljöer i [!DNL Adobe Commerce as a Cloud Service]. Den här versionen är planerad att övergå till produktionsmiljöer den 10 februari 2026.
...
* Förbättrade färdiga onlinenyttolaster för leverans med anpassade attribut för leveransadress. Den här ändringen gör det möjligt för handlare att implementera anpassade leveransmetoder. <!-- ACCS-235 -->

* Ökad åtkomst till administratörsrapporter, inklusive rapporter för marknadsföring, försäljning, kunder och produkter. <!-- CCSAAS-3085 -->

### Hämta anpassade fakturabelopp via REST API

Faktura-API:t har nu stöd för anpassade fångstmängder med tilläggsattribut. Med den här funktionen kan handlare hämta ett anpassat belopp när de skapar en faktura med REST-slutpunkten `POST V1/order/:orderId/invoice` och anger beloppet i fältet `extension_attributes.custom_capture_amount` för nyttolasten. Det innebär att handlarna får större flexibilitet för partiella inhämtningar och specialiserade betalningsscenarier. Kontakta din supportrepresentant för att aktivera den här funktionen. <!-- ACCS-186, ACCS-197, ACCS-143 -->
