...
* **Verktygstillgänglighet**: Dedikerade verktyg för kundanvändning för Commerce massdatamigreringar kommer att vara tillgängliga i mitten av juli 2025. Om kunderna behöver hjälp med att migrera data satsvis på förhand kan Adobe på deras vägnar underlätta dataöverföringen.
