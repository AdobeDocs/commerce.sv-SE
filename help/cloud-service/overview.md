...
| [Betalningar](https://experienceleague.adobe.com/sv/docs/commerce-admin/stores-sales/payments/payments) | [Betalningstjänster för Adobe Commerce](../payment-services/guide-overview.md) | Tillgänglig | En integrerad betalningstjänst som underlättar säkra och effektiva transaktioner. |
