...
>
> Du kan också lägga till flera användare till en roll genom att skapa en [användargrupp](https://helpx.adobe.com/enterprise/using/user-groups.html){target="_blank"}. Sedan kan du lägga till lämpliga produkter i användargruppen.
...
* **Användare** - Användare har administratörsåtkomst till Commerce Admin men kan inte hantera åtkomst på produktnivå i Admin Console. Användare kan också använda krediter för att [skapa instanser](./getting-started.md#create-an-instance) i [!DNL Commerce Cloud Manager].
  ...
  >[!TIP]
  >
  >Om du vill begränsa åtkomsten till Commerce Admin via IP-adressen läser du [Begränsa produktåtkomst via IP-adresser](https://helpx.adobe.com/enterprise/using/ip-based-access.html){target="_blank"}.
