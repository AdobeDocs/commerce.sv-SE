...
1. Välj auktoriseringsmetoden server-till-server som du implementerade på menyn **Adobe Developer Authorization Type** . Adobe rekommenderar att du använder OAuth. [Läs mer](https://developer.adobe.com/commerce/webapi/rest/authentication/server-to-server/).
