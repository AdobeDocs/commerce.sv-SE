...
![Åtgärdat problem](../assets/fix.svg)<!-- Issue ACAP-1180 --> Allmänna förbättringar på produktredigeringssidan. Nu återges sidorna korrekt när AEM Assets-integreringen är aktiverad.
