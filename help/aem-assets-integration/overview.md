...
I dessa videofilmer lär du dig hur du konfigurerar och använder AEM Assets-integreringen med Adobe Commerce.
...
>[!TAB ACCS-självstudiekurs]

Lär dig hur du använder Adobe Commerce as a Cloud Service tillsammans med AEM Assets.
...
1. Konfigurera integreringen för din miljö:

   * [!BADGE Endast PaaS]{type=Informative tooltip="Gäller endast Adobe Commerce i molnprojekt (Adobe-hanterad PaaS-infrastruktur)."} [Adobe Commerce (PaaS/ACCS)](get-started/setup-synchronization.md)
   * [!BADGE Endast SaaS]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Gäller endast Adobe Commerce as a Cloud Service- och Adobe Commerce Optimizer-projekt (SaaS-infrastruktur som hanteras av Adobe)."} [Adobe Commerce Optimizer](get-started/configure-aco.md)
